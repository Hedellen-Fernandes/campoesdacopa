...
class WinnersTableViewController: UITableViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        let vc = segue.destination as! WorldCupViewController //Define o destino da segue e acessa os metodos e atributos dela
    ...
    func loadWorldCups() {
        ...
        do {
            ...
            print("Console error generate")
        }
    }
//      QUANDO O RETORNO FOR 1, EU NAO PRECISO IMPLEMENTAR O METODO
